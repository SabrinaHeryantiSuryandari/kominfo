...
<form action="" method="POST">
    ...
    <div class="card shadow mb-3 ">
        <div class="card-header py-2 " style="background-color: #40B9CB;">
            <h6 class="m-0 font-weight-bold text-white text-center">Masukkan Data Pengadaan</h6>
        </div>
        <div class="card-body">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 text-center mt-3">
                    <div class="form-group text-center">
                        <tr>
                            <td>
                                <br>
                                <a href="/home" type="submit" type="button" class="btn btn-danger text-center">Kembali</a>
                            </td>
                            <td>
                                <button type="submit" type="button" class="btn btn-success text-center">Submit</button>
                            </td>
                        </tr>
