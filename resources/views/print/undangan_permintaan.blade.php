        ...
        <div class="card-body">
            ...
            <table border="0" align="center" font-size="2">
                <tr>
                    ...
                    <td>:</td>
                    <td width="455">Rabu/24 Agustus 2022</td>
                </tr>
            </table>
            <table border="0" align="center" font-size="2">
                <tr>
            ...
            <table border="0" align="center" font-size="2">
                <tr>
                    ...
                    <td>:</td>
                    <td width="455">Ruang Argopuro Dinas Komunikasi Dan Informatika Provinsi</td>
                </tr>
            </table>
            <table border="0" align="center" font-size="2">
                <tr>
                    <td width="105"> </td>
                    <td> </td>
                    <td width="455">Jawa Timur Jl. Ahmad Yani 242 - 244 Surabaya</td>
                </tr>
            </table>
            <table border="0" align="center" font-size="2">
                <tr>
