...
<div class="col-12 grid-margin stretch-card">
    <div class="card shadow">
        <div class="card-body">
            ...
            <br>
            <p>Kepada   : Yth. Sdr.	Panitia Pengadaan Dinas Komunikasi dan Informatika Provinsi Jawa Timur</p>
            <p>D a r i  : Pejabat Pembuat Komitmen</p>
            <p>Tanggal  : 12 Agustus 2022</p>
            <p>Nomor    : 020/654.2/114.6/2022</p>
            <p>Sifat    : Segera</p>
            ...
            <br>
            <p>     Sehubungan dengan hal tersebut diatas, untuk penyedia Barang/Jasa ditunjuk  CV. PATRIA NUGRAHA, JL. Kanwa No. 22-A Kota Surabaya. Untuk itu diminta bantuannya untuk segera diproses sesuai prosedur yang berlaku.</p>
            <p>     Demikian untuk pelaksanaannya.</p>
            <p>PEJABAT PEMBUAT KOMITMEN</p>
            <br>
            <br>
            <br>
            <p>I WAYAN RUDY ARTHA, S.Kom</p>
            <p>NIP. 19770517 200901 1 005</p>
        </div>
    </div>
</div>
